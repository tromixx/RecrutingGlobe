...
public class MatchForCoach extends AppCompatActivity {
    ...
    private void logout() {
        ...
        Intent intent = new Intent(MatchForCoach.this, login_option_activity.class);
    ...
    public void onBackPressed (){
        Intent intent = new Intent(MatchForCoach.this, MainActivity.class);
        startActivity(intent);
        finish();
    }
    ...
    private void getUserMatchId() {
        DatabaseReference matchDb = FirebaseDatabase.getInstance().getReference().child("Athlete").child(currentUserId).child("connection").child("match");
    ...
    private void fetchMatchInformation(String key) {
        DatabaseReference userDb = FirebaseDatabase.getInstance().getReference().child("coach").child(key);
