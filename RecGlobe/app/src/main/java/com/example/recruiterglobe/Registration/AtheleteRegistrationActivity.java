...
import com.example.recruiterglobe.LoginAndProfile.AtheleteLoginActivity;
...
public class AtheleteRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_athelete_registration);
        ...
        mRegister = (Button) findViewById(R.id.athlete_register);
        ...
        mLogin.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent(AtheleteRegistrationActivity.this, AtheleteLoginActivity.class);
                startActivity(intent);
            }
        });
